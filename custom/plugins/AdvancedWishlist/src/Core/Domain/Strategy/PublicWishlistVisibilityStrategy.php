...
/**
 * Strategy for determining visibility of public wishlists.
 */
class PublicWishlistVisibilityStrategy implements WishlistVisibilityStrategy
{
    ...
    {
        // Public wishlists can only be edited by their owner
    ...
    {
        // Public wishlists can be shared by anyone
        return true;
    }

    public function getSupportedType(): string
    {
        return WishlistType::PUBLIC;
    }
